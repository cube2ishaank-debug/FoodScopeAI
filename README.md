...
<br> 
### Format
The dataset folder is filled with .jpg images inside folders labelled with there classes like 'milk' or 'apple'.
<br>
Main Folder>>Category>>Image
## AI Models
All of the models created for this project will be found in the releases for this repository as downloadable '.pth' files.
